...
Generated by `tools/camera_resolvability.py`. Measures how far ahead the camera can actually resolve the lane, independent of whether `camera_visibility.py` counts a point as "visible" -- see `LOOKAHEAD_M` vs these limits.
